...
EXTERN int natoms_ptype INIT(0);       /* Total ptype atoms added by Sudheer */
EXTERN int natoms_qtype INIT(0);       /* Total qtype atoms added by Sudheer */
